...
# theme colors
BG_COLOR = "#fdeded" # lavednar blush
CARD_COLOR = "#fbfffe" # white
TEXT_DARK = "#001514" # black
TEXT_MUTED = "#5f4b66" # vintge grape
...
class PasswordManagerApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Local Passowrd Manager")
...
# first page
    def show_setup_screen(self):
        ...
        pw_entry = ctk.CTkEntry(
            ...
            fg_color=CARD_COLOR, border_color="#e5d5c8", corner_radius=12
        )
        ...
        ctk.CTkButton(
            ...
            fg_color=ACCENT_CORAL, text_color=ACCENT_CORAL_TEXT, hover_color="#d85a30"
        ).pack(pady=20)
# unlock
    def show_unlock_screen(self):
        ...
        pw_entry = ctk.CTkEntry(
            frame, placeholder_text="Master password", show="*", width=300,
            fg_color=CARD_COLOR, border_color="#d487b6", corner_radius=12
        )
        pw_entry.pack(pady=8)
        ...
        ctk.CTkButton(
            ...
            fg_color=ACCENT_CORAL, text_color=ACCENT_CORAL_TEXT, hover_color="#2e1c2b" # voliet
        ).pack(pady=20)
        pw_entry.focus()
...
# Your Vault text
        ...
        ctk.CTkButton(
            ...
            fg_color=ACCENT_CORAL, text_color=BG_COLOR, hover_color="#d85a30",
...
# fills with what is in self entires
    ...
    def refresh_entry_list(self):
        ...
        avatar_colors = ["#f5c4b3", "#cebcf6", "#9fe1cb", "#f4c0d1", "#fac775"]
        ...
        for index, entry in enumerate(self.entries):
            ...
            ctk.CTkButton(
                ...
                fg_color=ACCENT_CORAL, text_color=CARD_COLOR, hover_color="#d85a30",
    ...
    def show_add_entry_dialog(self):
        ...
        site_entry = ctk.CTkEntry(dialog, width=280, fg_color=CARD_COLOR, corner_radius=10, border_color="#e5d5c8")
        site_entry.pack()

        ctk.CTkLabel(dialog, text="Username / email", text_color=TEXT_MUTED, font=ctk.CTkFont(size=12)).pack(pady=(16, 4))
        user_entry = ctk.CTkEntry(dialog, width=280, fg_color=CARD_COLOR, corner_radius=10, border_color="#e5d5c8")
        user_entry.pack()

        ctk.CTkLabel(dialog, text="Password", text_color=TEXT_MUTED, font=ctk.CTkFont(size=12)).pack(pady=(16, 4))
        pass_entry = ctk.CTkEntry(dialog, width=280, show="*", fg_color=CARD_COLOR, corner_radius=10, border_color="#e5d5c8")
        pass_entry.pack()
        ...
        ctk.CTkButton(
            ...
            fg_color=BG_COLOR, text_color=BG_COLOR, hover_color="#d85a30"
        ).pack(pady=20)
        site_entry.focus()
         #######################
